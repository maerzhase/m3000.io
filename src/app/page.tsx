            ...
            <Timeline>
              ...
              >
                <Text render={<p />}>
                  ...
                  <OverlayTrigger id="fxhash" variant="plain"><CardDeck /></OverlayTrigger>{" "}
                  fxhash is known for its open, uncurated
              ...
              >
                <Text render={<p />}>
                  ...
                  digital products.{" "}
                  <OverlayTrigger id="nand" variant="plain"><CardDeck /></OverlayTrigger>{" "}
                  I led the design technology team in
                  conceiving and realizing projects that ranged from
              ...
              >
                <Text render={<p />}>
                  ...
                  <OverlayTrigger id="artcom" variant="plain"><CardDeck /></OverlayTrigger>
                </Text>
              </Station>
