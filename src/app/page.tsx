        ...
        <div className="min-h-screen p-6 gap-16 sm:p-12 container m-auto">
          <main className="flex flex-col gap-[32px]">
            ...
            <Text>
              ...
              — a topic that has since become central to modern AI systems such
              as ChatGPT.
            </Text>
            <Text>
              ...
              multiple blockchains. fxhash is known for its open, uncurated
              model that lets artists mint generative works freely, and for
              pioneering ways to connect code, community, and art in a
            ...
            <Text>
              ...
              studio specialized in data visualization, UX, and interactive
              digital products. I led the design technology team in conceiving
              and realizing projects that ranged from user-facing digital
              products to large-scale exhibitions and interactive installations,
