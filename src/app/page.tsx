        ...
        <RedactedProvider>
          <div className="min-h-screen p-6 gap-16 sm:p-12 container m-auto">
            <main className="flex flex-col gap-[32px] select-none">
              ...
              >
                <Text render={<p />}>
                  <RedactedArea>
                    ...
                    <OverlayTrigger id="fxhash">see more</OverlayTrigger>,
              ...
              >
                <Text render={<p />}>
                  <RedactedArea>
                    ...
                    specialized in data visualization, UX, and interactive
                    digital products. I led the design technology team in
              ...
              <Station title="Education" year={"2010-2015"} name="">
                <Text render={<p />}>
                  <RedactedArea>
                    I studied{" "}
            ...
            <footer className="flex flex-col gap-4 mt-8">
              ...
              <Text size="3" render={<h3 />}>
                <RedactedArea>Interested to collaborate?</RedactedArea>
              </Text>
              <Text render={<p />}>
                <RedactedArea>
                  Get in touch via&nbsp;
